...
const WarningElement = ({status, statusText, is404}) => {
  return (
    <div className={styles.plate404}>
      <div>
          ...
          <p className={styles.titleDescMin}>{is404 ? 'Но у нас есть куча других классных страниц' : 'Попробуйте ещё раз'}</p>
          <div className={styles.buttonPlate}>
              <Link to='/'><HighPaddingButton>На главную</HighPaddingButton></Link>
          </div> 
      </div>
    </div>
  )
