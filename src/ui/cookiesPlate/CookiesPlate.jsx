...
const CookiesPlate = () => {
  ...
  useEffect(()=>{
    setTimeout(()=> {larestVisible ? setVisible(styles.notVisible) : setVisible('')}, 7000);
  }, [])
  ...
  return (
    <div className={styles.cookiesLine + ' ' + visible}>
      <div className={styles.cookiesPlate}>
        <h5 className={styles.cookiesTitleText}>Мы используем cookie файлы для вашего комфорта и удобства при использовании сайта</h5>
        <h6 className={styles.buttonInfo} onClick={()=> dispatchModalVisible(refreshModalInfoCookieAction(true))}>Подробнее</h6>
