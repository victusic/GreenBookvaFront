...
import { refreshProfileBaseAction, refreshProfileFavoritesAction, refreshProfileShoppingCartAction, refreshProfileFavoritesListAction, 
    refreshProfileShoppingCartListAction, refreshProfileCardsListAction, refreshProfileRequestAction } from "../../store/profileReducer"
...
export const fetchDeleteProfile = (id) => {
    return function (dispatchSign){
        fetch('https://db.green-bookva.shop/profile/' + id,{ method: 'DELETE' }) 
...
export const fetchDeleteCard = (id) => {
    return function (dispatchSign){
        fetch('https://db.green-bookva.shop/card/' + id,{ method: 'DELETE' }) 
        .then(window.location.reload())
    }
}
