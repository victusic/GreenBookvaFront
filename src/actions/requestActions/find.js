export const getFindProductsList = async (findString, limit, page, sort, isStock, bindings, badges, autors, publishers, manufacturers, minPrice, maxPrice) => {
...
export const getFindCountProductsList = async (findString, isStock, bindings, badges, autors, publishers, manufacturers, minPrice, maxPrice) => {
