...
export const profileReducer = (state = defaultState, action) =>{
    switch(action.type){
        ...
        case DEL_SHOPPING_CART_FROM_LIST:
            return {...state, shopping_cartList: state.shopping_cartList.filter(item => item.id !== action.payload)}
...
export const refreshProfileShoppingCartAction = (payload) => ({type: REFRESH_SHOPPING_CART_PROFILE, payload});
...
export const refreshProfileShoppingCartListAction = (payload) => ({type: REFRESH_SHOPPING_CART_LIST, payload});
export const addProfileShoppingCartFromListAction = (payload) => ({type: ADD_SHOPPING_CART_FROM_LIST, payload});
export const delProfileShoppingCartFromListAction = (payload) => ({type: DEL_SHOPPING_CART_FROM_LIST, payload});
