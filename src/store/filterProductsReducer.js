...
export const filterProductsReducer = (state = defaultState, action) =>{
    switch(action.type){
        ...
        case DEL_CHANGE_MANUFACTURERS:
            return {...state, changeManufacturers: state.changeManufacturers.filter(item => item !== action.payload)}
        ...
        case SET_RESET_FILTER:
            return {...state, changeBadges: [], changeAuthors: [], changePublishers: [], changeManufacturers: [], changeBindings: [], 
                isStock: false, changeMinPrice: 0, changeMaxPrice: 120}
