...
export const modalVisibleReducer = (state = defaultState, action) =>{
    switch(action.type){
        ...
        case REFRESH_MODAL_VISIBLE:
            return {...state, modalVisible: false, modalSignVisible: false, modalSignCodeVisible: false, modalSignUpVisible: false, modalSignUpFinishVisible: false, 
                modalUpdateProfileVisible: false, modalDeleteProfileVisible: false, modalViewCartVisible: false, modalDeleteCartVisible: false, modalAddCartVisible: false,
                modalCheckCodeVisible: false, modalOrderVisible: false, modalProductLimitVisible: false, modalPayVisible: false, modalAddReviewVisible: false,
                modalUpdateReviewVisible: false, modalDeleteReviewVisible: false, modalCookieInfoVisible: false
            }
        default:
            return state;
    }
...
export const refreshModalSIgnCodeVisibleAction = (payload) => ({type: REFRESH_MODAL_SIGN_CODE_VISIBLE, payload});
export const refreshModalSIgnUpVisibleAction = (payload) => ({type: REFRESH_MODAL_SIGN_UP_VISIBLE, payload});
export const refreshModalSIgnUpFihishVisibleAction = (payload) => ({type: REFRESH_MODAL_SIGN_UP_FINISH_VISIBLE, payload});
export const refreshModalVisibleAction = () => ({type: REFRESH_MODAL_VISIBLE});
export const refreshModalUpdateProfileAction = (payload) => ({type: REFRESH_MODAL_UPDATE_PROFILE_VISIBLE, payload});
export const refreshModalDeleteProfileAction = (payload) => ({type: REFRESH_MODAL_DELETE_PROFILE_VISIBLE, payload});
export const refreshModalViewCartAction = (payload) => ({type: REFRESH_MODAL_VIEW_CART_VISIBLE, payload});
export const refreshModalDeleteCartAction = (payload) => ({type: REFRESH_MODAL_DELETE_CART_VISIBLE, payload});
...
export const refreshModalProductLimtAction = (payload) => ({type: REFRESH_MODAL_PRODUCT_LIMIT_VISIBLE, payload});
export const refreshModalAddReviewAction = (payload) => ({type: REFRESH_MODAL_ADD_REVIEW_VISIBLE, payload});
export const refreshModalUpdateReviewAction = (payload) => ({type: REFRESH_MODAL_UPDATE_REVIEW_VISIBLE, payload});
export const refreshModalDeleteReviewAction = (payload) => ({type: REFRESH_MODAL_DELETE_REVIEW_VISIBLE, payload});
export const refreshModalInfoCookieAction = (payload) => ({type: REFRESH_MODAL_INFO_COOKIE_VISIBLE, payload});