...
//Свайпы курсором
  ...
  return (
    ...
    <div className={styles.sliderBase} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} ref={elementRef} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp}>
