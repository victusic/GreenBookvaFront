...
const OrdersGridPlate = ({orders, typeSort}) => {
  ...
  return (
    <div className={styles.orderPlate}>
      ...
      {finalOrders.length > 0 && <h4 className={styles.bottomText}>В связи с тем, что конечная сумма оплаты заказа конвертируется в долларах, стоимость заказа в истории указывается в этой же валюте для корректного отображения цены, вне зависимости от текущих курсов других валют</h4>}
    </div>
  )
}
