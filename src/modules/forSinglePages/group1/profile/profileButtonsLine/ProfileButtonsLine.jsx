...
import { refreshCheckCodeAction, refreshModalDeleteProfileAction, refreshModalUpdateProfileAction } from '../../../../../store/modalVisibleReducer';
...
const ProfileButtonsLine = () => {
  ...
  return (
    <div className={styles.buttonLine}>
        ...
        <HighPaddingButton onClick={exit} style={{background: '#D3DFDA'}}>Выйти</HighPaddingButton>
    </div>
  )
}
