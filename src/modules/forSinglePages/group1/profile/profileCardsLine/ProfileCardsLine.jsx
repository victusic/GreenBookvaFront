...
import { refreshAddCartAction, refreshCheckCodeAction, refreshModalViewCartAction } from '../../../../../store/modalVisibleReducer';
...
const ProfileCardsLine = () => {
  ...
  return (
    <>
      ...
      <HorisontalScroll>
        {cards.map((card)=>
            <Card number={card.code} date={card.monthyear} margin={true} key={card.id} onClick={()=>getCard(card.id)}></Card>
        )}
