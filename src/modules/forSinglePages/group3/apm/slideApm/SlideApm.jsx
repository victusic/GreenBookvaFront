    ...
    <>
      {info.image
        ?<div className={styles.slideBack}>
            <img className={styles.slideImg} src={`${apmRoute}${imagePath}/${info.image}`}  alt={'Изображение слайда не загрузилось'}/>
            <p className={styles.slideText}><h3 className={styles.slideTextStyle}>{info.slide_text}</h3></p>
          </div>
