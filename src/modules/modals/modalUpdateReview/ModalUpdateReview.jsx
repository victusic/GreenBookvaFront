...
import { refreshModalDeleteReviewAction, refreshModalUpdateReviewAction } from '../../../store/modalVisibleReducer';
    ...
    <div className={visibleModal}>
      <Modal>
        <Form onSubmit={patchReview}>
          ...
          <ModalButton type='button' onClick={delReview} style={{background: '#D3DFDA', marginBottom: '20px'}}>Удалить</ModalButton>
