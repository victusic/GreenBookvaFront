    ...
    <div className={visibleModal}>
      <Modal>
        <Form onSubmit={updateProfile}>
          ...
          <ModalWarning visibleWarning={visibleWarningImage}>Размер изображения не должен превышать 5 мб</ModalWarning>
          ...
          <div className={stylesLocal.svgPlate}>
            <ModalInput type="text" placeholder='Виктор' value={name} onChange={e=>setName(e.target.value)} style={{color: color}} />
            <HandySvg src={colorSvg} className={stylesLocal.inputSvg} onClick={visiblePicker}/>
          </div>
          
          <ModalInInput>Фамилия</ModalInInput>
          <ModalWarning visibleWarning={visibleWarningSurname}>Длина имени может составлять от 2 до 14 символов</ModalWarning>
          
          <ModalInput type="text" placeholder='Хорошилов' value={surname} onChange={e=>setSurname(e.target.value)} />
