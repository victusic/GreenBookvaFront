  ...
  return (
    <div className={visibleModal}>
      <Modal>
        ...
        <ModalDescription>Максимальное количество товаров в 1 заказе не превышать 12 шт. Добавьте товар в избранное, и после заказа верните в корзину</ModalDescription>
      </Modal>
    </div>
  )
}
