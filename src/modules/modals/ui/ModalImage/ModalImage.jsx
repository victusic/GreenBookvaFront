...
const ModalImage = ({image, alt, ...props}) => {
  ...
  return (
    <div className={styles.imagePad}>
      <input type='file' ref={imagePicker} className={styles.imageForm} accept=".png, .jpg, .jpeg, .gif, .webp" {...props}/>
      <div className={styles.imageBlockPad}>
        ...
        <div className={styles.changeImage} onClick={changeImage}>Загрузить изображение</div>
      </div>
    </div>
  )
}
