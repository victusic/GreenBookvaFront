  ...
  return (
    <div className={visibleModal}>
      <Modal>
        ...
        <ModalDescription>Чтобы войти или зарегистрироваться, укажите свой адрес электронной почты:</ModalDescription>
        <ModalWarning visibleWarning={visibleWarning}>Убедитесь, в правильности ввода адреса почты</ModalWarning>
        <ModalInput type="email" placeholder="Адрес почты" value={mail} onChange={e=>setMail(e.target.value)}/>
