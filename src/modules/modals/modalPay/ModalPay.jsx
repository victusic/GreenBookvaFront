  ...
  return (
    <div className={visibleModal}>
      <Modal>
        ...
        <Select options={cardsMap} addStyle={styleForModal.selectModalWidth} onChange={(e)=>setNowCardId(e.target.value)}/>
        {isNewCard 
          ? 
          <>
            ...
            <ModalCard setCardCode={setCardCode} setCardMonthyear={setCardMonthyear} number={cardCode} date={cardMonthyear} cvv={true} cardCVV={cardCVV} setCardCVV={setCardCVV}/> 
            <Checkbox checked={saveCard} onChange={() =>setSaveCard(!saveCard)}>Сохранить карту в профиле</Checkbox>
          </>
          : <div className={styleForModal.selectModalWidth}>
              <ModalWarning visibleWarning={visibleWarningCVV}>Проверьте правильность CVV кода</ModalWarning>
              <Card number={nowCard.number} date={nowCard.date} cvv={true} cardCVV={cardCVV} setCardCVV={setCardCVV}/>
            </div>
        }
