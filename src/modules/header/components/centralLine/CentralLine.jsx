...
import { fetchProfileFavorites, fetchProfileShoppingCart, fetchProfileFavoritesList, fetchProfileShoppingCartList } from '../../../../actions/storeActions/profile';
    ...
    <div className={styles.centralLine}>
        <Pad>
          <div className={styles.centralFlex}>
            ...
            <FindInput visible={visible} setVisible={setVisible} oldFinds={oldFinds} setOldFinds={setOldFinds}/>
            <nav className={styles.buttonBoxPlate}>
              ...
              <div className={styles.buttonBox} onClick={()=>dispatchVisible(refreshModalSIgnVisibleAction(true))}>
                <HandySvg src={profileSvg} className={styles.buttonBoxSvg} />
