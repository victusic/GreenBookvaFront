...
const Footer: React.FC = () => {
  ...
  const passphraseLink = useSelector((state: RootState) => state.externalLinks.passphrase);
    ...
    <footer className={styles.plate}>
      <Pad>
        ...
        <div className={styles.bottomLine}>
          <span className={styles.bottomLineText}>Ⓒ 2024 Green BookVA by Khoroshilov Viktor</span>
        </div>
      </Pad>
    </footer>
  );
